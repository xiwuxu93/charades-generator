...
export default function CharadesGenerator({ 
  ...
  title = 'Random Charades Generator - Free & Instant',
  description = 'Generate random charades words instantly from our database of 1000+ carefully curated words and ideas!',
  hideFilters = false,

...
export const metadata: Metadata = {
  title: "Movie Charades Generator - Free Film & Cinema Word Ideas [No Ads]",
  description:
    "Free movie charades generator with 200+ films from Hollywood classics to modern blockbusters. Perfect for movie night parties, film buffs, and cinema lovers!",
  keywords:
    "movie charades generator, film charades ideas, charades movies list, movie title charades, cinema charades generator, hollywood charades game",
  alternates: {
  ...
  openGraph: {
    title: "Movie Charades Generator - Free Film & Cinema Word Ideas [No Ads]",
    description:
      "Free movie charades generator with films from Hollywood classics to modern blockbusters.",
    type: "website",
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Lights, camera, action! Act out classic Hollywood films, modern
            blockbusters, animated favorites, and indie gems. Perfect for movie
            lovers and film buffs!
          </p>
        </div>

        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">
            Movie Genres We Cover
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <li>
                  Show the movie&apos;s genre first (action, romance, etc.)
                </li>
              </ul>
            </div>
            <div>

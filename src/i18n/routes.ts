...
export const baseRoutes: RouteConfig[] = [
  ...
  { path: "/reverse-charades-game/", changeFrequency: "weekly", priority: 0.75 },
  { path: "/emotion-charades/", changeFrequency: "weekly", priority: 0.75 },
  { path: "/animal-charades-game/", changeFrequency: "weekly", priority: 0.75 },
  { path: "/hard-charades-ideas/", changeFrequency: "weekly", priority: 0.75 },
